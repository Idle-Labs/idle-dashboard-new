...
export const operators: Record<string, Operator> = {
  ...
  blockAnalitica: {
    ...
    description:
      "Established in 2018, our company set out on a mission to offer risk-related services within the DeFi arena.",
  },
  steakhouseFinancial: {
    founded: 2023,
  ...
  maven11: {
    ...
    description:
      "M11 Credit acts as a pool curator/administrator managing the vault’s reporting and epoch cycles.",
  },
  falconx: {
    rating: "AA",
    founded: "-",
  ...
  fasanara: {
    ...
    description:
      "Fasanara Digital is the digital asset arm of Fasanara Capital, a $4bn London-based hedge fund. It operates as a quantitative investment fund applying a scientific approach to investing in digital assets with the aim of achieving exceptional risk-adjusted returns for investors.",
  },
  wintermute: {
    rating: "-",
    founded: 2017,
  ...
  portofino: {
    ...
    links: {
      ...
      crunchbase:
        "https://www.crunchbase.com/organization/portofino-technologies",
    },
    description:
  ...
  wincent: {
    ...
    description:
      "Wincent (Wincent Investment Fund PCC Limited) is a leading crypto market maker with $3B+ daily volume and 300K+ daily transactions.",
  },
  bastion: {
    rating: "A",
    founded: 2014,
