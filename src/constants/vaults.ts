...
import GearboxPool from "abis/gearbox/GearboxPool.json";
...
export interface TrancheConfig {
  ...
  underlyingToken: string;
  pointsEmission?: Record<string, PointEmission>;
  vaultType?: string;
  modal?: any;
  variant?: string;
  operators?: VaultOperator[];
  ...
  1101: {
    clearpool: {
      USDCFas: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0xa75dd592826fa9c679ec03beefb1777ba1a373a0?market=ethereum" class="link" rel="nofollow noopener noreferrer" target="_blank">Fasanara USDC borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDT: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0x4a90c14335e81829d7cb0002605f555b8a784106?market=ethereum" class="link" rel="nofollow noopener noreferrer" target="_blank">Portofino USDT borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
  ...
  10: {
    clearpool: {
      USDTBas: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0xe6be721ccc9552d79bdc0d9cc3638606c3bdadb5?market=optimism" class="link" rel="nofollow noopener noreferrer" target="_blank">Bastion USDT borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDCWin: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0xa3aad4020f9c2e336c6bc0461948c94447a335f5?market=optimism" class="link" rel="nofollow noopener noreferrer" target="_blank">Wincent USDC borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      */
      USDCWinOld: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0x463a9fb7320834b7f8a5c4713434257c8971b9a8?market=optimism" class="link" rel="nofollow noopener noreferrer" target="_blank">wincent USDCe borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDTFas: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0x87181362ba304fec7e5a82ad2b7b503d7ad62639?market=optimism" class="link" rel="nofollow noopener noreferrer" target="_blank">Fasanara USDT borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDTPor: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0x462c4b2e69a59ff886980f36300c168234b63464?market=optimism" class="link" rel="nofollow noopener noreferrer" target="_blank">Portofino USDT borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
  ...
  137: {
    quickswap: {
      CXETHWETH: {
        ...
        messages: {
          buyInstructions:
            'To get CXETHWETH token your have to supply liquidity into the <a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://quickswap.exchange/#/add/0xfe4546feFe124F30788c4Cc1BB9AA6907A7987F9/0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619">Quickswap cxETH-ETH pool</a>.',
        },
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
  ...
  1: {
    usual: {
      USD0PP: {
        ...
        underlyingToken: "USD0PP",
        enabledEnvs: ["prod", "beta"],
        vaultType: "interestRateSwap",
        adaptiveYieldSplitEnabled: true,
        flags: {},
        CDO: {
          abi: IdleCDO as Abi,
        ...
        Tranches: {
          AA: {
            ...
            CDORewards: {
              ...
              unstakeWithBalance: false,
              abi: TrancheStakingRewards as Abi,
              name: "TrancheStakingRewards_usual_USD0PP_AA",
              address: "0x0000000000000000000000000000000000000000",
            },
          ...
          BB: {
            ...
            CDORewards: {
              ...
              unstakeWithBalance: true,
              abi: IdleCDOTrancheRewards as Abi,
              name: "IdleCDOTrancheRewards_usual_USD0PP_BB",
              address: "0x0000000000000000000000000000000000000000",
            },
            blockNumber: 16375825,
            label: "usual USDC BB",
    ...
    gearbox: {
      USDC: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.gearbox.fi/pools/0xda00000035fef4082f78def6a8903bee419fbf8e" class="link" rel="nofollow noopener noreferrer" target="_blank">Gearbox USDC V3 Pool</a> generating passive yield while automatically harvesting the GEAR rewards distributed.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      WETH: {
        ...
        pointsEmission: {
          RSETH: {
            ...
            assetName: "KELP",
            tooltip:
              "assets.assetDetails.tooltips.gearboxKelpMilesPointsEmission",
          },
        },
        CDO: {
          abi: IdleCDO as Abi,
        ...
        Pool: {
          abi: GearboxPool as Abi,
          name: "Gearbox_Pool_WETH",
        ...
        risks: [
          {
            ...
            description:
              "This scenario may occur when the borrow rate of WETH is higher than the lending rate of stETH, this usually don't last for a long time. In this case losses will be equally distributed between Junior and Senior and the vault continue to work as expected.",
          },
          {
            title: "2) Loss between 0.5% and 5%",
            description:
              "In this scenario the Junior tranche will absorb the entire loss (if enough TVL) and the vault will continue to work as expected.",
          },
          {
            title: "3) Loss higher than 5%",
            description:
              "We consider this as an hacking event. In this scenario both the Senior and Junior tranches are paused and further deposits and redeems prevented.",
          },
          {
            title: "4) Withdraw fee",
            description:
              'Instadapp Lite charges a 0.05% withdraw fee that is sent to the DAO as revenue. (<a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://lite.guides.instadapp.io/information/fees">Instadapp Lite Fees</a>)',
          },
        ],
        description:
          'This strategy deposits the stETH into <a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://lite.instadapp.io/">Instadapp Lite stETH v2</a> vault which utilizes a recursive strategy with stETH on lending protocols, enabling borrowing against ETH. Instadapp Vaults have automation functions which automatically rebalance the vault during market changes. If vault gets risky it can first refinance into another protocol to maintain safety, or it can deleverage by selling stETH and paying back ETH debt. This kind of automation, if required or occurs, may incur losses caused by trading slippage. Please visit the <a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://lite.guides.instadapp.io/information/risks">Instadapp Lite Risks</a> page before using this vault.<br />The APR is dynamically adjusted according to the coverage provided to the counterpart Senior tranche thanks to the <a href="https://medium.com/idle-finance/adaptive-yield-split-foster-pyts-liquidity-scalability-a796fa17ea35" class="link" rel="nofollow noopener noreferrer" target="_blank">Adaptive Yield Split</a>.',
        messages: {
          deposit:
            'Instadapp Lite charges a <strong>0.05% withdraw fee</strong> that is sent to the DAO as revenue. (<a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://lite.guides.instadapp.io/information/fees">Instadapp Lite Fees</a>)',
          withdraw:
            'Instadapp Lite charges a <strong>0.05% withdraw fee</strong> that is sent to the DAO as revenue. (<a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://lite.guides.instadapp.io/information/fees">Instadapp Lite Fees</a>)',
          buyInstructions:
            'To get stETH token your have to deposit first into <a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://stake.lido.fi">Lido ETH staking</a>.',
        },
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
    ...
    lido: {
      ...
      MATIC: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://polygon.lido.fi/" class="link" rel="nofollow noopener noreferrer" target="_blank">Lido MATIC pool</a>.',
        messages: {
    ...
    convex: {
      FRAX3CRV: {
        ...
        description:
          "This strategy accrue interest only after an harvest is done. The returns from an harvest are linearly released in 24 hours, so you should wait 24 hours after an harvest to see all the interests you are eligible for.",
        messages: {
          ...
          buyInstructions:
            'To get FRAX3CRV token your have to deposit first into <a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://curve.fi/frax/deposit">FRAX Curve Pool</a>.',
        },
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
      ...
      steCRV: {
        ...
        messages: {
          // withdraw:'The returns from an harvest are linearly released in 24 hours, so you should wait 24 hours after an harvest to see all the interests you are eligible for.',
          buyInstructions:
            'To get steCRV token your have to deposit first into <a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://curve.fi/steth/deposit">stETH Curve Pool</a>.',
        },
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
      ...
      ALUSD3CRV: {
        ...
        messages: {
          // withdraw:'The returns from an harvest are linearly released in 24 hours, so you should wait 24 hours after an harvest to see all the interests you are eligible for.',
          buyInstructions:
            'To get ALUSD3CRV token your have to deposit first into <a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://curve.fi/alusd/deposit">ALUSD Curve Pool</a>.',
        },
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
      ...
      PBTCCRV: {
        ...
        messages: {
          // withdraw:'The returns from an harvest are linearly released in 24 hours, so you should wait 24 hours after an harvest to see all the interests you are eligible for.',
          buyInstructions:
            'To get PBTCCRV token your have to deposit first into <a class="link" rel="nofollow noopener noreferrer" target="_blank" href="https://curve.fi/factory/99/deposit">PBTC Curve Pool</a>.',
        },
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
    ...
    euler: {
      USDC: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.euler.finance/market/0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48" class="link" rel="nofollow noopener noreferrer" target="_blank">Euler USDC pool</a>.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      DAI: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.euler.finance/market/0x6b175474e89094c44da98b954eedeac495271d0f" class="link" rel="nofollow noopener noreferrer" target="_blank">Euler DAI pool</a>.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDT: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.euler.finance/market/0xdac17f958d2ee523a2206206994597c13d831ec7" class="link" rel="nofollow noopener noreferrer" target="_blank">Euler USDT pool</a>.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDTStaking: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.euler.finance/market/0xdac17f958d2ee523a2206206994597c13d831ec7" class="link" rel="nofollow noopener noreferrer" target="_blank">Euler USDT pool</a> and automatically stake the received eUSDT to earn additional EUL rewards.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      WETHStaking: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.euler.finance/market/0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2" class="link" rel="nofollow noopener noreferrer" target="_blank">Euler WETH pool</a> and automatically stake the received eWETH to earn additional EUL rewards.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      DAIStaking: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.euler.finance/market/0x6b175474e89094c44da98b954eedeac495271d0f" class="link" rel="nofollow noopener noreferrer" target="_blank">Euler DAI pool</a> and automatically stake the received eDAI to earn additional EUL rewards.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      AGEUR: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.euler.finance/market/0x1a7e4e63778b4f12a199c062f3efdd288afcbce8" class="link" rel="nofollow noopener noreferrer" target="_blank">Euler AGEUR pool</a>.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
    ...
    */
    clearpool: {
      USDC: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0x4a90c14335e81829d7cb0002605f555b8a784106?market=ethereum" class="link" rel="nofollow noopener noreferrer" target="_blank">Portofino USDC borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDCWin: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0xCb288b6d30738db7E3998159d192615769794B5b?market=ethereum" class="link" rel="nofollow noopener noreferrer" target="_blank">Wintermute USDC borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDCWinc: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0xCb288b6d30738db7E3998159d192615769794B5b?market=ethereum" class="link" rel="nofollow noopener noreferrer" target="_blank">Wincent USDC borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDCFolk: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0xe3d20a721522874d32548b4097d1afc6f024e45b?market=ethereum" class="link" rel="nofollow noopener noreferrer" target="_blank">Folkvang USDC borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDT: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://clearpool.finance/permissionless/pools/0x1a1d778776542c2efed161ba1fbcfe6e09ba99fb?market=ethereum" class="link" rel="nofollow noopener noreferrer" target="_blank">Fasanara USDT borrowing pool</a> on Clearpool.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
    ...
    ethena: {
      USDe: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://app.ethena.fi/stake" class="link" rel="nofollow noopener noreferrer" target="_blank">Ethena USDe</a> staking pool and get sUSDe in exchange. To withdraw your funds you need to wait a cooldown period of 7 days, after which you can claim back your USDe.<br /><br /><h3 style="font-weight:bold">Ethena Sats Campaign</h3><p>Following the latest updates to the <a href="https://ethena.notion.site/Sats-Campaign-FAQ-3ae1f067ff834efc95b12148a434f668" class="link" rel="nofollow noopener noreferrer" target="_blank" class="link">Sats Campaign of USDe</a>, Senior LPs can leverage up their Ethena Sats exposure. On top of Senior Sats, LPs will receive Junior Sats as well and boost their Sats multiplier based on Junior liquidity.</p>',
        messages: {
    ...
    morpho: {
      ...
      USDC: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://aave.morpho.org/?network=mainnet" class="link" rel="nofollow noopener noreferrer" target="_blank">Morpho Aave USDC pool</a>.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      DAI: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://aave.morpho.org/?network=mainnet" class="link" rel="nofollow noopener noreferrer" target="_blank">Morpho Aave DAI pool</a>.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      USDT: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://aave.morpho.org/?network=mainnet" class="link" rel="nofollow noopener noreferrer" target="_blank">Morpho Aave USDT pool</a>.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
      ...
      WETH: {
        ...
        description:
          'This strategy deploys funds in the <a href="https://aave.morpho.org/?network=mainnet" class="link" rel="nofollow noopener noreferrer" target="_blank">Morpho Aave WETH pool</a>.',
        Tranches: {
          AA: {
            abi: ERC20 as Abi,
            decimals: 18,
...
export const aggregatedVaults: Record<string, AggregatedVault> = {
  stableSecuredLending: {
    ...
    description:
      "Algorithmically rebalanced vault to always achieve the highest yield",
  },
  rwa: {
    chainId: 10,
    color: "#627eea",
    ...
    description:
      "Diversified exposure to real-world asset-backed credit vaults, protected by first-loss capital",
  },
};
  ...
  1: {
    ...
    */
    USDCBB: {
      ...
      description:
        'This Junior Best Yield Vaults seek to maximize yields across multiple Junior yield sources (see protocols below). As deposited funds provide first-loss capital to an array of different Junior Tranches, it represent an aggressive target risk allocation strategy. <a href="https://docs.idle.finance/products/perpetual-yield-tranches" class="link" rel="nofollow noopener noreferrer" target="_blank">Learn more.</a>',
      protocols: [
        {
          decimals: 18,
          enabled: true,
