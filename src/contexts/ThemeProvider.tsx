...
import { DEFAULT_ENVIRONMENT, ENVIRONMENTS_HOSTNAMES } from 'constants/vars'
...
export function ThemeProvider({ children }: ProviderProps) {
  ...
  const environment = useMemo(() =>  ENVIRONMENTS_HOSTNAMES[window.location.hostname.toLowerCase()] || DEFAULT_ENVIRONMENT, [])
