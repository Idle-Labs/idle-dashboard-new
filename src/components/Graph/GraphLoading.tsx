...
export const GraphLoading = () => {
  ...
  const startColor = useColorModeValue('gray.300', '#1B1E27')
  const endColor = useColorModeValue('white', 'chart.loadingLine')

  const start = getColor(theme, startColor)
  const end = getColor(theme, endColor)

  const bgColor = useColorModeValue('white', 'chart.loadingBg')
